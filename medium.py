...
db = client["dbt_m"]  # Replace "your_database" with your actual database name
...
conf = {
    ...
    'group.id': 'medium_consumer_group',  # Consumer group for the "cold" topic
    'auto.offset.reset': 'earliest'
}

consumer = Consumer(conf)
consumer.subscribe(['medium'])  # Subscribe to the "cold" topic
...
try:
    while True:
        ...
        if elapsed_time >= 900:  # 10 minutes = 600 seconds
            # Show the result
            print(w.collect())
